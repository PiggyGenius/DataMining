...
There is more variables than data : we solve a linear system in which there is more unknown variables than equations. So there is a infinite number of solutions, that is why we have NA values.
