...
plot(pcamin:pcamax, mean_errors)
```
...
# ```{r}
# predictedCoord_best_pca = cbind(predictedCoord_best_pca, Pop=as.data.frame(NAm2[,"Pop"]))
# aggregate(long+lat ~ Pop, predictedCoord_best_pca, mean)
# ```
