...
regression_size = c(0:7)
#plot(regression_size, average_prediction_error, main = "Best average prediction error with respect to the regression size")
#print(regression_size)
